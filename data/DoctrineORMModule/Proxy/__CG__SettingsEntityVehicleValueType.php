 ...
 */
class VehicleValueType extends \Settings\Entity\VehicleValueType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Settings\\Entity\\VehicleValueType' . "\0" . 'id', '' . "\0" . 'Settings\\Entity\\VehicleValueType' . "\0" . 'valueType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VehicleValueType $proxy) {
