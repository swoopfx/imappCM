 ...
 */
class MarineCargoTransitMode extends \Settings\Entity\MarineCargoTransitMode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Settings\\Entity\\MarineCargoTransitMode' . "\0" . 'id', '' . "\0" . 'Settings\\Entity\\MarineCargoTransitMode' . "\0" . 'transitMode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MarineCargoTransitMode $proxy) {
