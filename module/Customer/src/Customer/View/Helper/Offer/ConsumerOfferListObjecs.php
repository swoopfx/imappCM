 ...
 *        
 */
class ConsumerOfferListObjecs extends AbstractHelper implements ServiceLocatorAwareInterface
{
    ...
    public function __invoke($objectArray){
        ...
        $frame = "";
        $objectTotal = 0;
        $link = "<p style='text-align: center;'><a id='btn3' 
						data-json='".json_encode($json)."'
						data-href='".$url("cus_offer/default", array("action"=>"selectobject"))."'
						class='btn ajax_element  paper-shadow relative btn-danger btn-stroke' data-z='0.5'
						data-hover-z='1' data-animated style='width: 100%' > Select a Property</a> <br> OR <br>
                ...
                $frame .= "<li class='list-group-item'>
							<div class='list-group-item media'
								...
								<div class='media-right'>
									<div class='width-100 text-right text-caption'><a style='width: 100%;' href='".$url("cus_offer/default", array("action"=>"remove-object", "id"=>$objectArray[$i]->getId()))."'  class='btn btn-xs btn-danger confirmation'>Remove</a></div>
								</div>
							</div>
