...
use GeneralServicer\Service\ErrorService;
use Wallet\Entity\WalletPasscode;
...
class WalletController extends AbstractActionController
{
    ...
    private $walletTransactionForm;

    private $walletPasscodeForm;

    /**
     *
     * @var WalletAddFundsForm
     */
    private $walletAddFundForm;
    
    /**
     * 
     * @var WalletChangePasscodeForm
     */
    private $walletChangePasscodeForm;
