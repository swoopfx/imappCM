 ...
 *        
 */
class CustomerMessagePackageHelper extends AbstractHelper implements ServiceLocatorAwareInterface
{
								...
								<div class='media v-middle'>
									...
									<div class='media-body'>
										<p class='text-subhead margin-v-5-0'>
											<strong> " . ($data[$i]->getBrokerFunction()->getId() == MessageService::MESSAGES_FUNCTION_SENDER ? "<p style='color: green;'>Recived From ".$brokerEntity->getBrokerName()."</p>" : "<p style='color: red;'>Sent By ".$customerPackageEntity->getCustomer()->getName()."</p>") . "<span class='text-muted'> " . date_diff(new \DateTime(), $data[$i]->getCreatedOn())->format("%a") . " days ago</span></strong>
										</p>
